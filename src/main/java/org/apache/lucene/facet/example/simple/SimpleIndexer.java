...
//            List<CategoryPath> facetList = SimpleUtils.categoryPathArrayToList(SimpleUtils.categories[docNum]);
            List<CategoryPath> facetList = SimpleUtils.categoryPathArrayToList(SimpleUtils.categories[0]);
            ...
            doc.add(new Field(SimpleUtils.TEXT, SimpleUtils.docTexts[docNum], Store.YES, Index.ANALYZED));
//            ExampleUtils.log("..." + SimpleUtils.docTexts[docNum] + "...");
...
//        ExampleUtils.log(nDocsAdded + " documents indexed with overall " + nFacetsAdded + " facets.");
    }
}
